...
curl 'https://api.ebuuhia.mn/api/v1/reportCustomerByUser?startLimit=0&endLimit=100&order=&sort=asc&search=&value=&reported=0&id=2015&action=0' \
...
{"data":{"result":[],"resultItem":[]},"pagination":4019}